...
namespace MyGame
{
    class StairsZPositif : CubeTexturé
    {

        public StairsZPositif(Game game, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, string nomTextureCube, Vector3 dimension)
