...
namespace MyGame
{
    class StairsXNegatif : CubeTexturé
    {

        public StairsXNegatif(Game game, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, string nomTextureCube, Vector3 dimension)
