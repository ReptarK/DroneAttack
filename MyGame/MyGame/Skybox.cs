...
{
    public class Skybox : PrimitiveDeBase
    {
        ...
        public Skybox(Game game, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, string nomTextureCube, Vector3 dimension)
