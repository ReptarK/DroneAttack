...
namespace MyGame
{
    class StairsXPositif : CubeTexturé
    {

        public StairsXPositif(Game game, float homothétieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, string nomTextureCube, Vector3 dimension)
        ...
        public override void GenererBoundingBox()
        {
            ...
            ListeNormales.Add(Vector3.UnitY * Data.GRAVITÉ * 1.6f); // STAIR
